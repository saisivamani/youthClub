        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="knsl-center knsl-title-frame">
              <h1 class="knsl-mb-20 knsl-h1-inner">Club Secretariat</h1>
              <ul class="knsl-breadcrumbs">
                <li><a href="index.php">Home</a></li>
                <li><span>Club Secretariat</span></li>
              </ul>
            </div>
            ...
            <div class="knsl-about-text">
              ...
              <tr>
                ...
                <tr>
                  <td><b>Address</b></td>
                  <td><b>:</b></td>
                  <td><b>Youth Club,JP Road Bhimavaram</b></td>
                </tr>
                <tr>
                  <td><b>Tel</b></td>
                  <td><b>:</b></td>
