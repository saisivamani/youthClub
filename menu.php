...
<!-- top bar end -->
        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="knsl-center knsl-title-frame">
              <h1 class="knsl-mb-20 knsl-h1-inner">Our luxurious Menu</h1>
              <p class="knsl-mb-30">We Are Providing Best Food</p>
    ...
    <section class="knsl-p-100-100">
      ...
      <div class="container">
        ...
        <div class="knsl-filter knsl-mb-60">
          ...
          <a href="#" data-filter=".main" class="knsl-work-category">Main dishes</a>
          <a href="#" data-filter=".starters" class="knsl-work-category">Starters</a>
            ...
            <div class="knsl-menu-card">
              ...
              <div class="knsl-description-frame">
                ...
                <div class="knsl-card-bottom">
                  <div class="knsl-price">$12.0<span>/night</span></div>
                </div>
              </div>
            </div>
            <!-- menu card end -->
          ...
          <div class="knsl-masonry-grid-item knsl-masonry-grid-item-25 desserts">
            ...
            <div class="knsl-menu-card">
              ...
              <div class="knsl-description-frame">
                ...
                <div class="knsl-text-light knsl-text-sm knsl-mb-20">Libero, non, aut, dignissimos, optio hic.</div>
                <div class="knsl-card-bottom">
                  <div class="knsl-price">$5.0<span>/night</span></div>
                </div>
              </div>
            </div>
            <!-- menu card end -->
          ...
          <div class="knsl-masonry-grid-item knsl-masonry-grid-item-25 desserts">
            ...
            <div class="knsl-menu-card">
              ...
              <div class="knsl-description-frame">
                ...
                <div class="knsl-text-light knsl-text-sm knsl-mb-20">Libero, non, aut, dignissimos, optio hic.</div>
                <div class="knsl-card-bottom">
                  <div class="knsl-price">$23.0<span>/night</span></div>
                </div>
              </div>
            </div>
            <!-- menu card end -->
          ...
          <div class="knsl-masonry-grid-item knsl-masonry-grid-item-25 salads">
            ...
            <div class="knsl-menu-card">
              ...
              <div class="knsl-description-frame">
                ...
                <div class="knsl-text-light knsl-text-sm knsl-mb-20">Libero, non, aut, dignissimos, optio hic.</div>
                <div class="knsl-card-bottom">
                  <div class="knsl-price">$45.0<span>/night</span></div>
                </div>
              </div>
            </div>
            <!-- menu card end -->
          ...
          <div class="knsl-masonry-grid-item knsl-masonry-grid-item-25 desserts">
            ...
            <div class="knsl-menu-card knsl-scroll-animation">
              ...
              <div class="knsl-description-frame">
                ...
                <div class="knsl-text-light knsl-text-sm knsl-mb-20">Libero, non, aut, dignissimos, optio hic.</div>
                <div class="knsl-card-bottom">
                  <div class="knsl-price">$7.0<span>/night</span></div>
                </div>
              </div>
            </div>
            <!-- menu card end -->
          </div>
          <div class="knsl-masonry-grid-item knsl-masonry-grid-item-25 main">
            ...
            <div class="knsl-menu-card knsl-scroll-animation">
              ...
              <div class="knsl-description-frame">
                ...
                <div class="knsl-text-light knsl-text-sm knsl-mb-20">Libero, non, aut, dignissimos, optio hic.</div>
                <div class="knsl-card-bottom">
                  <div class="knsl-price">$39.0<span>/night</span></div>
                </div>
              </div>
            </div>
            <!-- menu card end -->
          ...
          <div class="knsl-masonry-grid-item knsl-masonry-grid-item-25 desserts">
            ...
            <div class="knsl-menu-card knsl-scroll-animation">
              ...
              <div class="knsl-description-frame">
                ...
                <div class="knsl-text-light knsl-text-sm knsl-mb-20">Libero, non, aut, dignissimos, optio hic.</div>
                <div class="knsl-card-bottom">
                  <div class="knsl-price">$25.0<span>/night</span></div>
                </div>
              </div>
            </div>
            <!-- menu card end -->
          ...
          <div class="knsl-masonry-grid-item knsl-masonry-grid-item-25 main">
            ...
            <div class="knsl-menu-card knsl-scroll-animation">
              ...
              <div class="knsl-description-frame">
                ...
                <div class="knsl-text-light knsl-text-sm knsl-mb-20">Libero, non, aut, dignissimos, optio hic.</div>
                <div class="knsl-card-bottom">
                  <div class="knsl-price">$17.0<span>/night</span></div>
                </div>
              </div>
            </div>
            <!-- menu card end -->
          ...
          <div class="knsl-masonry-grid-item knsl-masonry-grid-item-25 desserts">
            ...
            <div class="knsl-menu-card knsl-scroll-animation">
              ...
              <div class="knsl-description-frame">
                ...
                <div class="knsl-text-light knsl-text-sm knsl-mb-20">Libero, non, aut, dignissimos, optio hic.</div>
                <div class="knsl-card-bottom">
                  <div class="knsl-price">$29.0<span>/night</span></div>
                </div>
              </div>
            </div>
            <!-- menu card end -->
          ...
          <div class="knsl-masonry-grid-item knsl-masonry-grid-item-25 salads">
            ...
            <div class="knsl-menu-card knsl-scroll-animation">
              ...
              <div class="knsl-description-frame">
                ...
                <div class="knsl-text-light knsl-text-sm knsl-mb-20">Libero, non, aut, dignissimos, optio hic.</div>
                <div class="knsl-card-bottom">
                  <div class="knsl-price">$13.0<span>/night</span></div>
                </div>
              </div>
            </div>
            <!-- menu card end -->
          ...
          <div class="knsl-masonry-grid-item knsl-masonry-grid-item-25 main">
            ...
            <div class="knsl-menu-card knsl-scroll-animation">
              ...
              <div class="knsl-description-frame">
                ...
                <div class="knsl-text-light knsl-text-sm knsl-mb-20">Libero, non, aut, dignissimos, optio hic.</div>
                <div class="knsl-card-bottom">
                  <div class="knsl-price">$16.0<span>/night</span></div>
                </div>
              </div>
            </div>
            <!-- menu card end -->
    ...
    <!-- menu -->
    <section class="knsl-transition-top knsl-p-0-100" style="background-color: #ECFAFB">
      <img src="img/palm.svg" class="knsl-deco-left" alt="palm">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-12">
            ...
            <div class="knsl-center knsl-title-frame knsl-scroll-animation knsl-mb-100">
              <h2 class="knsl-mb-20">Special Offers</h2>
              <p class="knsl-mb-30">Consectetur adipisicing elit. Nihil, illum voluptate eveniet ex fugit ea delectus, sed voluptatem. Laborum accusantium libero commodi id officiis itaque esse adipisci, necessitatibus asperiores, illo odio.</p>
            ...
            <div class="swiper-container knsl-uni-slider">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  ...
                  <div class="knsl-menu-card knsl-scroll-animation">
                    <div class="knsl-cover-frame">
                      <img src="47.jpg" alt="about">
                    </div>
                    <div class="knsl-description-frame">
                      <h3 class="knsl-mb-20">Сasserole</h3>
                      <div class="knsl-text-light knsl-text-sm knsl-mb-20">Libero, non, aut, dignissimos, optio hic.</div>
                      <div class="knsl-card-bottom">
                        <div class="knsl-price"><sup><span>$99</span>&ensp;</sup>$75.0<span>/night</span></div>
                      </div>
                    </div>
                  </div>
                  <!-- menu card end -->
                ...
                <div class="swiper-slide">
                  ...
                  <div class="knsl-menu-card knsl-scroll-animation">
                    ...
                    <div class="knsl-description-frame">
                      ...
                      <div class="knsl-text-light knsl-text-sm knsl-mb-20">Libero, non, aut, dignissimos, optio hic.</div>
                      <div class="knsl-card-bottom">
                        <div class="knsl-price"><sup><span>$59</span>&ensp;</sup>$44.0<span>/night</span></div>
                      </div>
                    </div>
                  </div>
                  <!-- menu card end -->
                ...
                <div class="swiper-slide">
                  ...
                  <div class="knsl-menu-card knsl-scroll-animation">
                    ...
                    <div class="knsl-description-frame">
                      ...
                      <div class="knsl-text-light knsl-text-sm knsl-mb-20">Libero, non, aut, dignissimos, optio hic.</div>
                      <div class="knsl-card-bottom">
                        <div class="knsl-price"><sup><span>$79</span>&ensp;</sup>$53.0<span>/night</span></div>
                      </div>
                    </div>
                  </div>
                  <!-- menu card end -->
                ...
                <div class="swiper-slide">
                  ...
                  <div class="knsl-menu-card knsl-scroll-animation">
                    ...
                    <div class="knsl-description-frame">
                      ...
                      <div class="knsl-text-light knsl-text-sm knsl-mb-20">Libero, non, aut, dignissimos, optio hic.</div>
                      <div class="knsl-card-bottom">
                        <div class="knsl-price"><sup><span>$1199</span>&ensp;</sup>$999.0<span>/night</span></div>
                      </div>
                    </div>
                  </div>
                  <!-- menu card end -->
    ...
    <!-- testimonials -->
    <section class="knsl-p-0-80" style="background-color: #ECFAFB">
      <img src="img/palm.svg" class="knsl-deco-left" alt="palm">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-12">
            ...
            <div class="knsl-center knsl-title-frame knsl-scroll-animation knsl-mb-80">
              <h2 class="knsl-mb-20">Feedback from our Guests</h2>
            ...
            <div class="swiper-slider knsl-testimonials-slider knsl-scroll-animation">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  ...
                  <div class="knsl-testimonial-card">
                    <div class="knsl-avatar-frame">
                      <img src="img/43.jpg" alt="Avatar">
                    </div>
                    <div class="knsl-name-and-text">
                      <h3 class="knsl-mb-10">Oscar Newman</h3>
                      <div>From Poland</div>
                      <blockquote>
                        <ul class="knsl-stars">
                        ...
                        Dequi folores dolor sit amet, consectetur adipisicing elit. Nesciunt illo, delectus totam! Delectus illo magnam voluptatem a tempora id vitae dolor, quis natus iusto molestiae ab nam error vero possimus ullam facilis porro
                        veritatis?
                      </blockquote>
                    </div>
                  </div>
                ...
                <div class="swiper-slide">
                  ...
                  <div class="knsl-testimonial-card">
                    <div class="knsl-avatar-frame">
                      <img src="img/44.jpg" alt="Avatar">
                    </div>
                    <div class="knsl-name-and-text">
                      <h3 class="knsl-mb-10">Emma Trueman</h3>
                      <div>From Poland</div>
                      <blockquote>
                        <ul class="knsl-stars">
                          <li><i class="fas fa-star"></i></li>
                ...
                <div class="swiper-slide">
                  ...
                  <div class="knsl-testimonial-card">
                    <div class="knsl-avatar-frame">
                      <img src="img/45.jpg" alt="Avatar">
                    </div>
                    <div class="knsl-name-and-text">
                      <h3 class="knsl-mb-10">Viktoria Freeman</h3>
                      <div>From Poland</div>
                      <blockquote>
                        <ul class="knsl-stars">
                          <li><i class="fas fa-star"></i></li>
                ...
                <div class="swiper-slide">
                  ...
                  <div class="knsl-testimonial-card">
                    <div class="knsl-avatar-frame">
                      <img src="img/46.jpg" alt="Avatar">
                    </div>
                    <div class="knsl-name-and-text">
                      <h3 class="knsl-mb-10">Paul Oldman</h3>
                      <div>From Poland</div>
                      <blockquote>
                        <ul class="knsl-stars">
                          <li><i class="fas fa-star"></i></li>
