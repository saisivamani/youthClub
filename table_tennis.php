        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="knsl-center knsl-title-frame">
              <h1 class="knsl-mb-20 knsl-h1-inner">Table Tennis</h1>
          ...
          <div class="row g-0">
            <div class="col-lg-6">
              <div class="knsl-about-text">
                ...
                <li>The timings for table tennis will be from 06.00 AM to 10.00AM and 16.00 PM to 21.00 PM on all days. Monthly Charges for the Members is Rs per month.</li> 
                </div>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="knsl-about-photo">
                <img src="img/17.jpg" alt="cover">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row align-items-center">
        <div class="col-lg-12">
          ...
          <div class="knsl-center knsl-title-frame knsl-scroll-animation knsl-mb-100">
            <h2 class="knsl-mb-20">Gallery</h2>
            <a href="gallery.php" target="_blank" class="knsl-btn knsl-btn-md">View More</a>
          </div>
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                ...
                <div class="knsl-image-frame">
                  <a data-fancybox="gallery" href="img/17.jpg">
                    <img src="img/17.jpg" alt="about">
